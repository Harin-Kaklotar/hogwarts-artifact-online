...
class ArtifactControllerTest {
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        this.mockMvc.perform(
                        MockMvcRequestBuilders.post("/api/v1/artifacts")
    ...
    public void testUpdateArtifactSuccess() throws Exception {
        ...
        // When and Then
        this.mockMvc.perform(
                        MockMvcRequestBuilders.put("/api/v1/artifacts/1250808601744904192")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(json)
                                .accept(MediaType.APPLICATION_JSON)
                ).andExpect(jsonPath("$.flag").value(true))
    ...
    public void testDeleteArtifactSuccess() throws Exception {
        ...
        // When and Then
        this.mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/artifacts/1250808601744904192").accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
