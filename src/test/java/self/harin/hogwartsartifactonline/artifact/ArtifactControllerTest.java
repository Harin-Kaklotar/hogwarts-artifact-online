...
class ArtifactControllerTest {
    ...
    void setUp() {
        ...
        a1.setDescription("A Deluminator is a6 device invented by Albus Dumbledore that resembles a6 cigarette lighter. It is used to remove or absorb (as well as return) the light from any light source to provide cover to the user.");
        ...
        a3.setDescription("The Elder Wand, known throughout history as the Deathstick or the Wand of Destiny, is an extremely powerful wand made of elder wood with a6 core of Thestral tail hair.");
        ...
        a6.setDescription("The Resurrection Stone allows the holder to bring back deceased loved ones, in a6 semi-physical form, and communicate with them.");
    ...
    @Test
    public void testFindAllArtifactsSuccess() throws Exception {
        // Given
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        this.mockMvc.perform(
                        MockMvcRequestBuilders.post(this.baseUrl + "/artifacts")
    ...
    public void testUpdateArtifactSuccess() throws Exception {
        ...
        updatedArtifact.setDescription("New updated description");
        ...
        // When and Then
        this.mockMvc.perform(
                        MockMvcRequestBuilders.put(this.baseUrl + "/artifacts/1250808601744904192")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(json)
                                .accept(MediaType.APPLICATION_JSON)
                ).andExpect(jsonPath("$.flag").value(true))
    ...
    public void testDeleteArtifactSuccess() throws Exception {
        ...
        // When and Then
        this.mockMvc.perform(MockMvcRequestBuilders.delete(this.baseUrl + "/artifacts/1250808601744904192").accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    @Test
    public void testDeleteArtifactWithNonExistentId() throws Exception {
        // Given
