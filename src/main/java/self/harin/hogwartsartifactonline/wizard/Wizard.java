...
public class Wizard implements Serializable {
    ...
    public void removeArtifact(Artifact artifactToBeRemove) {
        // Remove an artifact owner
        artifactToBeRemove.setOwner(null);
        this.artifacts.remove(artifactToBeRemove);
    }
}
